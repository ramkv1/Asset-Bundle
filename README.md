...
The 'dbabProj' project was generated by using the default-python template.

src/: Python source code for this project.
src/dbabProj/: Shared Python code that can be used by jobs and pipelines.
...
This deploys everything that's defined for this project. For example, the default template would deploy a pipeline called [dev yourname] dbabProj_etl to your workspace. You can find that resource by opening your workpace and clicking on Jobs & Pipelines.
...
Finally, to run tests locally, use pytest:
